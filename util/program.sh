...
CLEAR_BIT_PATH=/util/bitstreams/clear.bit
...
user="_user"
app="/dev/xdma0_user"
/util/reg_rw $app 0x80000 w 0x1 

# Program clearing bitstream
vivado -mode batch -source /util/open_target.tcl -tclargs $CLEAR_BIT_PATH

# Program new partial bitstream
vivado -mode batch -source /util/open_target.tcl -tclargs $1
